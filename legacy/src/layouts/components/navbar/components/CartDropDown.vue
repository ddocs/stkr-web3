<template>
  ...
  <vs-dropdown class="cursor-pointer" vs-custom-content vs-trigger-click>
    <feather-icon :badge="cartItems.length" class="cursor-pointer ml-4 mr-6 mt-1" icon="ShoppingCartIcon"/>
    <vs-dropdown-menu :class="{'dropdown-custom': cartItems.length}" class="cart-dropdown vx-navbar-dropdown">
      ...
      <template v-if="cartItems.length">
        ...
        <component :is="scrollbarTag" :key="$vs.rtl" ref="mainSidebarPs"
                   :settings="settings" class="scroll-area--cart-items-dropdowm p-0 mb-10">
            ...
            <li
              ...
              <div class="vx-col w-4/5 pr-4 pl-2 py-4 flex flex-col justify-center">
                ...
                <div class="flex items-center justify-between">
                  ...
                  <feather-icon class="hover:text-danger" icon="XIcon" svgClasses="h-4 w-4 cursor-pointer text-danger"
