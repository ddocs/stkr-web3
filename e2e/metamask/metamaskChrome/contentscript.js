...
})(
  {
    1: [
          ...
          (async function () {
            await (async function () {
              const e = new s.default({
                ...
                t = u.default.runtime.connect({ name: 'contentscript' }),
                r = new c.default(t),
                n = new a.default();
              n.setMaxListeners(25);
              const i = new a.default();
              i.setMaxListeners(25),
                (0, o.default)(n, e, n, e => h('MetaMask Inpage Multiplex', e)),
                (0, o.default)(i, r, i, e =>
                  h('MetaMask Background Multiplex', e),
                ),
                l('provider', n, i),
                l('publicConfig', n, i);
              i.createStream('phishing').once('data', p);
            })(),
              await (async function () {
      ...
      },
      {
        ...
        'extension-port-stream': 9,
        extensionizer: 24,
        'obj-multiplex': 29,
        path: 31,
        'post-message-stream': 32,
        pump: 35,
        querystring: 38,
      },
    ],
    ...
    5: [
      function (e, t, r) {
        ...
        function f(e) {
          for (
            var t = e.length < 0 ? 0 : 0 | l(e.length), r = o(t), n = 0;
            n < t;
            n += 1
          )
            r[n] = 255 & e[n];
        ...
        (r.kMaxLength = 2147483647),
          ...
          (s.concat = function (e, t) {
            ...
            for (r = 0; r < e.length; ++r) {
              var o = e[r];
              if ((U(o, Uint8Array) && (o = s.from(o)), !s.isBuffer(o)))
                throw new TypeError(
                  '"list" argument must be an Array of Buffers',
                );
        ...
        (s.prototype.slice = function (e, t) {
          ...
          (s.prototype.readFloatLE = function (e, t) {
            return (
              (e >>>= 0), t || R(e, 4, this.length), i.read(this, e, !0, 23, 4)
            );
          }),
          (s.prototype.readFloatBE = function (e, t) {
            return (
              (e >>>= 0), t || R(e, 4, this.length), i.read(this, e, !1, 23, 4)
            );
          }),
          (s.prototype.readDoubleLE = function (e, t) {
            return (
              (e >>>= 0), t || R(e, 8, this.length), i.read(this, e, !0, 52, 8)
            );
          }),
          (s.prototype.readDoubleBE = function (e, t) {
            return (
              (e >>>= 0), t || R(e, 8, this.length), i.read(this, e, !1, 52, 8)
            );
          }),
    ...
    9: [
        ...
        (function (r) {
          ...
          function o(e) {
            n.call(this, { objectMode: !0 }),
              (this._port = e),
              e.onMessage.addListener(this._onMessage.bind(this)),
              e.onDisconnect.addListener(this._onDisconnect.bind(this));
          }
          (t.exports = o),
            i(o, n),
            ...
            (o.prototype._write = function (e, t, n) {
              try {
                if (r.isBuffer(e)) {
                  var i = e.toJSON();
                  (i._isBuffer = !0), this._port.postMessage(i);
      ...
      { buffer: 5, 'readable-stream': 20, util: 54 },
    ],
    10: [
      function (e, t, r) {
        (function (e) {
    ...
    12: [
      ...
      { './_stream_transform': 14, 'core-util-is': 7, inherits: 19 },
    ],
    13: [
      function (e, t, r) {
        (function (r, n) {
    ...
    14: [
      ...
      { './_stream_duplex': 11, 'core-util-is': 7, inherits: 19 },
    ],
    15: [
      function (e, t, r) {
        (function (r, n, i) {
          ...
          function b(t) {
            if (
              ...
              !(d.call(b, this) || this instanceof a))
            )
              return new b(t);
            ...
            if (e._writev && r && r.next) {
              ...
              for (; r; ) {
                var c = r.chunk,
                  ...
                  l = r.callback;
                if (
                  (v(e, t, !1, t.objectMode ? 1 : c.length, c, f, l),
                  (r = r.next),
    ...
    24: [
      function (e, t, r) {
        const n = e('./extension-instance');
        t.exports = new n();
      },
      { './extension-instance': 23 },
    ],
    25: [
      function (e, t, r) {
    ...
    29: [
      ...
      { 'end-of-stream': 8, once: 30, 'readable-stream': 49 },
    ],
    30: [
      function (e, t, r) {
        var n = e('wrappy');
    ...
    31: [
      function (e, t, r) {
        (function (e) {
          ...
          (r.resolve = function () {
            for (
              var r = '', n = !1, i = arguments.length - 1;
              i >= -1 && !n;
              i--
            ) {
      ...
      function (e, t, r) {
        ...
        (t.exports = o),
          ...
          (o.prototype._write = function (e, t, r) {
            var n = { target: this._target, data: e };
            this._targetWindow.postMessage(n, this._origin), r();
          });
      },
      { 'readable-stream': 49, util: 54 },
    ],
    33: [
      function (e, t, r) {
        (function (e) {
    ...
    34: [
      function (e, t, r) {
        ...
        (o.nextTick = function (e) {
          ...
          f.push(new m(e, t)), 1 !== f.length || l || u(d);
        }),
    ...
    35: [
          ...
          t.exports = function () {
            ...
            var n = t.map(function (i, o) {
              ...
              return c(i, s, o > 0, function (t) {
                e || (e = t), t && n.forEach(f), s || (n.forEach(f), r(e));
              });
            });
            return t.reduce(l);
          };
      ...
      { _process: 34, 'end-of-stream': 8, fs: 4, once: 30 },
    ],
    36: [
      function (e, t, r) {
        'use strict';
    ...
    40: [
      ...
      { './_stream_transform': 42, 'core-util-is': 7, dup: 12, inherits: 26 },
    ],
    41: [
      function (e, t, r) {
        (function (r, n) {
          ...
          function k(e, t) {
            t.readingMore || ((t.readingMore = !0), i(A, e, t));
          }
          function A(e, t) {
            for (
              var r = t.length;
          ...
          function M(e) {
            ...
            if (t.length > 0)
              throw new Error('"endReadable()" called on non-empty stream');
            t.endEmitted || ((t.ended = !0), i(j, t, e));
          }
          function j(e, t) {
            e.endEmitted ||
              0 !== e.length ||
          ...
          (v.prototype.read = function (e) {
            ...
            (v.prototype.pipe = function (e, t) {
              ...
              o.endEmitted ? i(u) : n.once('end', u), e.on('unpipe', c);
              var l = (function (e) {
                return function () {
                  var t = e._readableState;
                  p('pipeOnDrain', t.awaitDrain),
            ...
            (v.prototype.on = function (e, t) {
              ...
              if ('data' === e)
                ...
                n.endEmitted ||
                  ...
                  ((n.readableListening = n.needReadable = !0),
                  (n.emittedReadable = !1),
                  n.reading ? n.length && S(this) : i(C, this));
              }
              return r;
            }),
            (v.prototype.addListener = v.prototype.on),
            (v.prototype.resume = function () {
              ...
              return (
                e.flowing ||
                  ...
                  (e.flowing = !0),
                  (function (e, t) {
                    t.resumeScheduled || ((t.resumeScheduled = !0), i(T, e, t));
                  })(this, e)),
                this
              );
            }),
      ...
      {
        './_stream_duplex': 39,
        './internal/streams/BufferList': 44,
    ...
    42: [
      ...
      { './_stream_duplex': 39, 'core-util-is': 7, inherits: 26 },
    ],
    43: [
      function (e, t, r) {
        (function (r, n, i) {
              ...
              r &&
                (!(function (e, t) {
                  t.prefinished ||
                    t.finalCalled ||
                    ('function' == typeof e._final
                      ? (t.pendingcb++, (t.finalCalled = !0), o(S, e, t))
                      : ((t.prefinished = !0), e.emit('prefinish')));
                })(e, t),
                0 === t.pendingcb && ((t.finished = !0), e.emit('finish'))),
              r
          ...
          c.inherits(b, l),
            ...
            'function' == typeof Function.prototype[Symbol.hasInstance]
              ? ((d = Function.prototype[Symbol.hasInstance]),
                Object.defineProperty(b, Symbol.hasInstance, {
                  value: function (e) {
                    return (
                      !!d.call(this, e) || (e && e._writableState instanceof y)
                    );
                  },
                }))
              : (d = function (e) {
            ...
            (b.prototype.write = function (e, t, r) {
              var n,
                ...
                s = !1,
                a =
                  ((n = e), (h.isBuffer(n) || n instanceof p) && !i.objectMode);
              return (
                a &&
                  !h.isBuffer(e) &&
                  (e = (function (e) {
    ...
    50: [
      ...
      { 'process/browser.js': 34, timers: 50 },
    ],
    51: [
      function (e, t, r) {
        (function (e) {
    ...
    54: [
      ...
      { './support/isBuffer': 53, _process: 34, inherits: 52 },
    ],
    55: [
      function (e, t, r) {
