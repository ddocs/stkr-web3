...
const locators = {
  setup: {
    ...
    importWindow: {
      ...
      termsAgree:
        '//*[@class="first-time-flow__checkbox first-time-flow__terms"]',
...
const data = {
  seedPhrase:
    'disagree social width elite journey tower spawn foam ugly witness turn frost kind grunt awkward manual pioneer cross risk grab aware sea glance tube',
  password: '12345678',
  privateKey:
    '4ea8639340b1301eafe87a155177c2188b697e557614d6a037a6c53c0570fd77',
...
class Metamask extends Page {
  get setupStartSetupBtn() {
    return $(locators.setup.startSetupBtn);
  }
  get setupImportWalletBtn() {
    return $(locators.setup.importWalletBtn);
  }
  get setupAgreeBtn() {
    return $(locators.setup.agreeBtn);
  }
  get setupImportSeedPhraseInput() {
    return $(locators.setup.importWindow.seedPhraseInput);
  }
  get setupImportSeedPassword() {
    return $(locators.setup.importWindow.password);
  }
  get setupImportSeedConfirmPassword() {
    return $(locators.setup.importWindow.confirmPassword);
  }
  get setupImportSeedTermsAgree() {
    return $(locators.setup.importWindow.termsAgree);
  }
  get setupImportSeedImportBtn() {
    return $(locators.setup.importWindow.importBtn);
  }
  get setupAllDoneBtn() {
    return $(locators.setup.allDoneBtn);
  }

  get closePopUpBtn() {
    return $(locators.closePopUpBtn);
  }

  get networkListBtn() {
    return $(locators.network.listBtn);
  }
  get networkRopstenLI() {
    return $(locators.network.ropstenLI);
  }

  get accountAccountIcon() {
    return $(locators.account.accountIcon);
  }
  get accountMenuImportAccount() {
    return $(locators.account.menuImportAccount);
  }
  get accountKeyInput() {
    return $(locators.account.keyInput);
  }
  get accountImportBtn() {
    return $(locators.account.importBtn);
  }

  get addTokenAddTokenBtn() {
    return $(locators.addToken.AddTokenBtn);
  }
  get addTokenCustomTokenTab() {
    return $(locators.addToken.CustomTokenTab);
  }
  get addTokenCustomAddressInput() {
    return $(locators.addToken.CustomAddressInput);
  }
  get addTokenNextBtn() {
    return $(locators.addToken.NextBtn);
  }
  get addTokenConfirmBtn() {
    return $(locators.addToken.ConfirmBtn);
  }

  get paymentUSDTOption() {
    return $(locators.payment.USDTOption);
  }
  get paymentANKROption() {
    return $(locators.payment.ANKROption);
  }
  get paymentFormAddressInput() {
    return $(locators.payment.form.addressInput);
  }
  get paymentFormAmountInput() {
    return $(locators.payment.form.amountInput);
  }
  get paymentFormNextBtn() {
    return $(locators.payment.form.nextBtn);
  }
  get paymentFormConfirmBtn() {
    return $(locators.payment.form.confirmBtn);
  }

  get integratePopUpNextBtn() {
    return $(locators.integratePopUp.nextBtn);
  }
  get integratePopUpConnectBtn() {
    return $(locators.integratePopUp.connectBtn);
  }

  get paymentPopUpConfirmBtn() {
    return $(locators.paymentPopUp.confirmBtn);
  }
