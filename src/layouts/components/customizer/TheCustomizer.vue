    ...
    <vs-sidebar
      ...
      <div class="h-full">
        ...
        <div class="customizer-header mt-6 flex items-center justify-between px-6">
          ...
          <feather-icon class="cursor-pointer" icon="XIcon" @click.stop="active = false"></feather-icon>
        </div>

        <vs-divider class="mb-0"/>

        <component :is="scrollbarTag" :key="$vs.rtl" :settings="settings" class="scroll-area--customizer pt-4 pb-6">
          ...
          <div class="px-6">
            ...
            <div class="mt-4">
              ...
              <div>
                <vs-radio v-model="layoutType" class="mr-4" vs-name="layout-type-vertical" vs-value="vertical">
                  Vertical
                </vs-radio>
                <vs-radio v-model="layoutType" class="mr-4" vs-name="layout-type-horizontal" vs-value="horizontal">
                  Horizontal
                </vs-radio>
              </div>
            </div>
            ...
            <div>
              ...
              <ul class="clearfix">
                ...
                <li class="float-left"><input v-model="customPrimaryColor"
                                              class="w-10 cursor-pointer h-10 rounded-lg m-2" type="color"/></li>
              </ul>
            </div>
            <!-- /THEME COLORS -->
            ...
            <div class="mt-4">
              ...
              <div>
                <vs-radio v-model="themeMode" class="mr-4" vs-name="theme-mode-light" vs-value="light">Light</vs-radio>
                <vs-radio v-model="themeMode" class="mr-4" vs-name="theme-mode-dark" vs-value="dark">Dark</vs-radio>
                <vs-radio
                    v-if="layoutType === 'vertical'"
                    v-model="themeMode"
                    vs-name="theme-mode-semi-dark"
                    vs-value="semi-dark">Semi Dark
                </vs-radio>
              </div>
            </div>
            ...
            <!-- NAVBAR TYPE -->
            <div class="mt-4">
              <h5 class="mb-2">{{ (layoutType === 'vertical' || windowWidth &lt; 1200) ? 'Navbar' : 'Nav Menu' }}
                Type</h5>
              <div>
                <vs-radio
                    ...
                    vs-value="hidden">Hidden
                </vs-radio>

                <vs-radio v-model="navbarTypeLocal" class="mr-4" vs-name="navbar-type-static" vs-value="static">Static
                </vs-radio>
                <vs-radio v-model="navbarTypeLocal" class="mr-4" vs-name="navbar-type-sticky" vs-value="sticky">Sticky
                </vs-radio>
                <vs-radio v-model="navbarTypeLocal" vs-name="navbar-type-floating" vs-value="floating">Floating
                </vs-radio>
              </div>
            </div>
            ...
            <div class="mt-4">
              ...
              <div>
                <vs-radio v-model="footerTypeLocal" class="mr-4" vs-name="footer-type-hidden" vs-value="hidden">Hidden
                </vs-radio>
                <vs-radio v-model="footerTypeLocal" class="mr-4" vs-name="footer-type-static" vs-value="static">Static
                </vs-radio>
                <vs-radio v-model="footerTypeLocal" vs-name="footer-type-sticky" vs-value="sticky">Sticky</vs-radio>
              </div>
            </div>
