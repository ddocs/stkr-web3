...
export declare class AETH extends BaseContract {
    ...
    decreaseAllowance(spender: string, subtractedValue: BN, options?: SendOptions): PromiEvent<Contract>;
    increaseAllowance(spender: string, addedValue: BN, options?: SendOptions): PromiEvent<Contract>;
    ...
    mint(account: string, amount: BN, options?: SendOptions): PromiEvent<Contract>;
    updateRatio(newRatio: BN, options?: SendOptions): PromiEvent<Contract>;
    ratio(options?: SendOptions): Promise<BN>;
    updateGlobalPoolContract(globalPoolContract: string, options?: SendOptions): PromiEvent<Contract>;
    burn(amount: BN, options?: SendOptions): PromiEvent<Contract>;
    symbol(options?: SendOptions): Promise<string>;
    name(options?: SendOptions): Promise<string>;
    setNewNameAndSymbol(options?: SendOptions): PromiEvent<Contract>;
    changeOperator(operator: string, options?: SendOptions): PromiEvent<Contract>;
}
export declare class AETHEvents extends EventBase {
    ...
    getPastRatioUpdate(options: PastEventOptions | {}): Promise<ContractEvent<IRatioUpdate>[]>;
    ...
    RatioUpdate(options: EventOptions | {}): SubscribeEvent<IRatioUpdate>;
